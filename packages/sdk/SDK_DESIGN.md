...
```ts
import { GeminiCliAgent } from '@wilhelm-tiger/gemini-cli-sdk';
...
```ts
import { GeminiCliAgent, tool, z } from "@wilhelm-tiger/gemini-cli-sdk";
...
```ts
import { GeminiCliAgent, hook, z } from '@wilhelm-tiger/gemini-cli-sdk';
...
```ts
import { hook } from "@wilhelm-tiger/gemini-cli-sdk";
...
```ts
import { GeminiCliAgent, subagent } from "@wilhelm-tiger/gemini-cli";
...
```ts
import { GeminiCliAgent, extension } from "@wilhelm-tiger/gemini-cli-sdk";
...
```ts
import { GeminiCliAgent } from "@wilhelm-tiger/gemini-cli-sdk";
import { GeminiCliAcpServer } from "@wilhelm-tiger/gemini-cli-sdk/acp";
