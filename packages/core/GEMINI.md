# Gemini CLI Core (`@wilhelm-tiger/gemini-cli-core`)
...
- Run tests: `npm test -w @wilhelm-tiger/gemini-cli-core`
- Run a specific test:
  `npm test -w @wilhelm-tiger/gemini-cli-core -- src/path/to/file.test.ts`
