# Gemini CLI Test Utils (`@wilhelm-tiger/gemini-cli-test-utils`)
...
1. **Programmatic Builder:**
   ...
   ```typescript
   import { TestMcpServerBuilder } from '@wilhelm-tiger/gemini-cli-test-utils';
...
Import from `@wilhelm-tiger/gemini-cli-test-utils` in test files across the
monorepo.
