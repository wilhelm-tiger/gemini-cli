...
import { debugLogger, isGitRepository } from '@wilhelm-tiger/gemini-cli-core';
...
export function getInstallationInfo(
  ...
  try {
    ...
    if (realPath.includes('/.volta/') || realPath.includes('/Volta/')) {
      const updateCommand = 'volta install @wilhelm-tiger/gemini-cli@latest';
      return {
    ...
    if (
      ...
      const updateCommand = 'pnpm add -g @wilhelm-tiger/gemini-cli@latest';
      return {
    ...
    if (realPath.includes('/.yarn/global')) {
      const updateCommand = 'yarn global add @wilhelm-tiger/gemini-cli@latest';
      return {
    ...
    if (realPath.includes('/.bun/install/global')) {
      const updateCommand = 'bun add -g @wilhelm-tiger/gemini-cli@latest';
      return {
    ...
    // Assume global npm
    const updateCommand = 'npm install -g @wilhelm-tiger/gemini-cli@latest';
    return {
