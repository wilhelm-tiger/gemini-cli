...
import { createMockMessageBus } from '@wilhelm-tiger/gemini-cli-core/src/test-utils/mock-message-bus.js';
...
describe('useToolScheduler', () => {
  ...
  it('resolves the schedule promise when scheduler resolves', async () => {
    ...
    const { Scheduler } = await import('@wilhelm-tiger/gemini-cli-core');
