...
describe('eval-analysis', () => {
  ...
  describe('tool reference extraction', () => {
    ...
    it('extracts tool from imported constant', () => {
      const analysis = analyzeEvalSource(`
        import { TRACKER_CREATE_TASK_TOOL_NAME } from '@wilhelm-tiger/gemini-cli-core';
        import { evalTest } from './test-helper.js';
        evalTest('USUALLY_PASSES', {
          name: 'tracker test',
    ...
    it('handles aliased constant imports', () => {
      const analysis = analyzeEvalSource(`
        import { TRACKER_CREATE_TASK_TOOL_NAME as CREATE_TOOL } from '@wilhelm-tiger/gemini-cli-core';
        import { evalTest } from './test-helper.js';
        evalTest('USUALLY_PASSES', {
          name: 'alias test',
          prompt: 'create task',
