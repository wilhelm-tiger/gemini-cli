...
this repository is to help you master AI agent development by building the exact
same agent architecture side-by-side in **Python, Go, and TypeScript**.

## Why a multi-language approach?

By building the identical agent structure in three different languages, you will
...
1.  **Learn universal concepts:** When you write a tool-calling loop in
    TypeScript, then rewrite it in Go and Python, you abstract away the
...
3.  **Build a reusable portfolio:** At the end of this journey, you will have
    three production-ready agent boilerplates that you can pull off the shelf
    depending on your future job requirements or project needs.

## The roadmap

We progress through specific milestones across all three languages
simultaneously. You can find the source code for these in the
`packages/agent-ts`, `packages/agent-py`, and `packages/agent-go` directories.
