...
<Tabs>
  ...
  <TabItem value="Homebrew (macOS/Linux)" label="Homebrew (macOS/Linux)">
  ...
  <TabItem value="MacPorts (macOS)" label="MacPorts (macOS)">
...
<Tabs>
  ...
  <TabItem value="Docker/Podman Sandbox" label="Docker/Podman Sandbox">
