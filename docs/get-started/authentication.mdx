...
For most users, we recommend starting Gemini CLI and using a Gemini API key.
...
| :--------------------------------------------------------------------- | :--------------------------------------------------------------- | :---------------------------------------------------------- |
| Individual Google accounts                                             | [Use Gemini API Key](#gemini-api)                                | No                                                          |
| Organization users with a company, school, or Google Workspace account | [Vertex AI](#vertex-ai)                                          | [Yes](#set-gcp)                                             |
...
> Google Cloud project for authentication when using a Gemini API key.

You may need to configure a Google Cloud project for Gemini CLI to use. This
applies when you meet at least one of the following conditions:
